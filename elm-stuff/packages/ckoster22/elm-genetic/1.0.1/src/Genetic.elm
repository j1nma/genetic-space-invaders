module Genetic exposing (getPopulation, IntermediateValue(IntermediateValue), Method(..), Options, dnaFromValue, executeInitialStep, executeStep, numGenerationsFromValue, solutionGenerator)
...
@docs getPopulation, IntermediateValue, Method, Options, dnaFromValue, executeInitialStep, executeStep, numGenerationsFromValue, solutionGenerator
...
{-| Returns the population for a given `IntermediateValue`
-}
getPopulation : IntermediateValue a -> Population a
getPopulation (IntermediateValue p pd gens) =
    p
